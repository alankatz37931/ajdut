...
export const dict = {
  ...
  adminApproval: {
    ...
    moderationActiveEyebrow: "Moderación · proyecto activo",
    moderationActiveBody: "El proyecto está activo y visible para los miembros.",
    moderationSuspendedEyebrow: "Moderación · proyecto inactivo",
    moderationSuspendedBody:
      "El proyecto está inactivo: no lo ven los miembros, solo vos y el project owner.",
  ...
  founderNuevoProyecto: {
    ...
    sectorLabel: "Sector",
    sectorPlaceholder: "Elegí un sector",
    sectorOptions: [
      "Tecnología",
      "Inmobiliario",
      "Comercio / Retail",
    ...
    sectorOther: "Otro",
    sectorOtherLabel: "¿Cuál? Describí el rubro",
    stageLabel: "Stage",
    ...
    kindMerchandise: "Mercancía",
    kindOther: "Otro",
    stageIdea: "Idea — concepto",
    stagePreSeed: "Pre-seed — inicios / prototipo",
    stageSeed: "Seed — producto viable",
    stageEarlyRevenue: "Early revenue — primeros ingresos sin constancia",
    stageGrowth: "Growth — ventas sistemáticas",
    stageScale: "Scale — en expansión territorial",
  },
