      ...
      <span className="group relative inline-block">
        ...
        {hasPhoto && !uploading && (
          <button
            ...
            className="absolute top-0 right-0 w-5 h-5 rounded-full bg-paper hairline flex items-center justify-center text-navy/60 hover:text-navy hover:border-navy p-0 m-0 cursor-pointer leading-none transition-opacity duration-150 opacity-0 group-hover:opacity-100 focus-visible:opacity-100"
          >
